---
name: amani-kyc-ui-react-native
description: "Integrate the Amani KYC UI SDK on React Native using the live Amani documentation. Use when adding or implementing the Amani KYC UI SDK on React Native."
metadata:
  amani:
    platform: "mobile"
    sdk: "kyc"
...
- **Requirements** — https://documentation.amani.ai/documents/reactnativeui/Requirements
- **Installation** — https://documentation.amani.ai/documents/reactnativeui/Installation
- **Manual Installation** — https://documentation.amani.ai/documents/reactnativeui/ManualInstallation
- **Integration** — https://documentation.amani.ai/documents/reactnativeui/Integration
- **Usage** — https://documentation.amani.ai/documents/reactnativeui/Usage
- **Permissions** — https://documentation.amani.ai/documents/reactnativeui/Permissions
- **SDK Release Notes** — https://documentation.amani.ai/documents/reactnativeui/ReleaseNote

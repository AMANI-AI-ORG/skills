---
name: amani-biomatch-ios
description: "Integrate the Amani BioMatch SDK on iOS using the live Amani documentation. Use when adding or implementing the Amani BioMatch SDK on iOS."
metadata:
  amani:
    platform: "mobile"
    sdk: "biomatch"
...
- **Preparation** — https://documentation.amani.ai/documents/iosbiomatch/Preparation
- **Usage** — https://documentation.amani.ai/documents/iosbiomatch/Usage
- **SDK Release Notes** — https://documentation.amani.ai/documents/iosbiomatch/ReleaseNote

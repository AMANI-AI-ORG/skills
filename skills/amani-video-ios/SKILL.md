---
name: amani-video-ios
description: "Integrate the Amani Video Call SDK on iOS using the live Amani documentation. Use when adding or implementing the Amani Video Call SDK on iOS."
metadata:
  amani:
    platform: "mobile"
    sdk: "video"
...
- **Preparation** — https://documentation.amani.ai/documents/iosVideo/Preparation
- **Initializing and using the SDK** — https://documentation.amani.ai/documents/iosVideo/initalizing-and-using-the-sdk
- **SDK Release Notes** — https://documentation.amani.ai/documents/iosVideo/ReleaseNotes

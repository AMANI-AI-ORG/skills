---
name: amani-kyc-ui-ios
description: "Integrate the Amani KYC UI SDK on iOS using the live Amani documentation. Use when adding or implementing the Amani KYC UI SDK on iOS."
metadata:
  amani:
    platform: "mobile"
    sdk: "kyc"
...
- **Preparation** — https://documentation.amani.ai/documents/iosui/Preparation
- **Usage** — https://documentation.amani.ai/documents/iosui/Usage
- **SDK Release Notes** — https://documentation.amani.ai/documents/iosui/ReleaseNote

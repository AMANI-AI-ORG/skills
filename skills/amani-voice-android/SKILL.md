---
name: amani-voice-android
description: "Integrate the Amani Voice Assistant SDK on Android using the live Amani documentation. Use when adding or implementing the Amani Voice Assistant SDK on Android."
metadata:
  amani:
    platform: "mobile"
    sdk: "voice"
...
# Amani Voice Assistant SDK — Android
...
- **AmaniVoiceAssistantAndroid** — https://documentation.amani.ai/documents/voiceAssistant/AmaniVoiceAssistantAndroid

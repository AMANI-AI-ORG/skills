---
name: amani-kyc-ui-android
description: "Integrate the Amani KYC UI SDK on Android using the live Amani documentation. Use when adding or implementing the Amani KYC UI SDK on Android."
metadata:
  amani:
    platform: "mobile"
    sdk: "kyc"
...
- **Preparation** — https://documentation.amani.ai/documents/androidui/Preparation
- **Usage** — https://documentation.amani.ai/documents/androidui/Usage
- **SDK Release Notes** — https://documentation.amani.ai/documents/androidui/ReleaseNote

---
name: amani-kyc-core-android
description: "Integrate the Amani KYC Core SDK on Android using the live Amani documentation. Use when adding or implementing the Amani KYC Core SDK on Android."
metadata:
  amani:
    platform: "mobile"
    sdk: "kyc"
...
- **Preparation** — https://documentation.amani.ai/documents/android/Preparation
- **Initializing the SDK** — https://documentation.amani.ai/documents/android/initializing-the-sdk
- **Bio Login Module** — https://documentation.amani.ai/documents/android/biologin/BioLogin
- **Bio Login with Backend V1** — https://documentation.amani.ai/documents/android/biologin/BioLoginV1Backend
- **Bio Login with Backend V2** — https://documentation.amani.ai/documents/android/biologin/BioLoginV2Backend
- **Customer Info Module** — https://documentation.amani.ai/documents/android/CustomerInfo
- **Document Capture Module** — https://documentation.amani.ai/documents/android/DocumentCapture
- **ID Capture Module** — https://documentation.amani.ai/documents/android/IDCapture
- **NFC Module** — https://documentation.amani.ai/documents/android/NFC
- **Selfie / Auto** — https://documentation.amani.ai/documents/android/selfie/AutoSelfie
- **Selfie / Manual** — https://documentation.amani.ai/documents/android/selfie/ManualSelfie
- **Selfie / Pose Estimation** — https://documentation.amani.ai/documents/android/selfie/PoseEstimationSelfie
- **Selfie Module** — https://documentation.amani.ai/documents/android/selfie/Selfie
- **Signature Module** — https://documentation.amani.ai/documents/android/DigitalSignature
- **SDK Release Notes** — https://documentation.amani.ai/documents/android/android_core_sdk_release_notes

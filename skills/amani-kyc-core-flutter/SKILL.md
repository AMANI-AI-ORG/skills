---
name: amani-kyc-core-flutter
description: "Integrate the Amani KYC Core SDK on Flutter using the live Amani documentation. Use when adding or implementing the Amani KYC Core SDK on Flutter."
metadata:
  amani:
    platform: "mobile"
    sdk: "kyc"
...
- **Preparation** — https://documentation.amani.ai/documents/flutter/Preparation
- **Initializing the SDK** — https://documentation.amani.ai/documents/flutter/initializing-the-sdk
- **Auto Selfie** — https://documentation.amani.ai/documents/flutter/Selfie/AutoSelfie
- **Customer Info** — https://documentation.amani.ai/documents/flutter/CustomerInfo
- **ID Capture** — https://documentation.amani.ai/documents/flutter/IDCapture
- **Manual Selfie** — https://documentation.amani.ai/documents/flutter/Selfie/ManualSelfie
- **NFC Capture** — https://documentation.amani.ai/documents/flutter/NFCCapture/NFCCapture
- **NFC Capture on Android** — https://documentation.amani.ai/documents/flutter/NFCCapture/NFCCaptureOnAndroid
- **NFC Capture on iOS** — https://documentation.amani.ai/documents/flutter/NFCCapture/NFCCaptureOnIOS
- **Pose Estimation Selfie** — https://documentation.amani.ai/documents/flutter/Selfie/PoseEstimation
- **Selfie** — https://documentation.amani.ai/documents/flutter/Selfie/Selfie
- **SDK Release Notes** — https://documentation.amani.ai/documents/flutter/ReleaseNote

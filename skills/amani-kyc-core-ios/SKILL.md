---
name: amani-kyc-core-ios
description: "Integrate the Amani KYC Core SDK on iOS using the live Amani documentation. Use when adding or implementing the Amani KYC Core SDK on iOS."
metadata:
  amani:
    platform: "mobile"
    sdk: "kyc"
...
- **Preparation** — https://documentation.amani.ai/documents/ios/Preparation
- **Initializing the SDK** — https://documentation.amani.ai/documents/ios/initializing-the-sdk
- **Bio Login Module** — https://documentation.amani.ai/documents/ios/biologin/BioLogin
- **Bio Login with Backend V1** — https://documentation.amani.ai/documents/ios/biologin/BioLoginV1Backend
- **Bio Login with Backend V2** — https://documentation.amani.ai/documents/ios/biologin/BioLoginV2Backend
- **Customer Info Module** — https://documentation.amani.ai/documents/ios/CustomerInfo
- **Document Capture Module** — https://documentation.amani.ai/documents/ios/DocumentCapture
- **ID Capture Module** — https://documentation.amani.ai/documents/ios/IDCapture
- **NFC Module** — https://documentation.amani.ai/documents/ios/NFC
- **Selfie / Auto** — https://documentation.amani.ai/documents/ios/selfie/AutoSelfie
- **Selfie / Manual** — https://documentation.amani.ai/documents/ios/selfie/ManualSelfie
- **Selfie / Pose Estimation (Active Liveness)** — https://documentation.amani.ai/documents/ios/selfie/PoseEstimation
- **Selfie Module** — https://documentation.amani.ai/documents/ios/selfie/Selfie
- **Signature Module** — https://documentation.amani.ai/documents/ios/Signature
- **SDK Release Notes** — https://documentation.amani.ai/documents/ios/ReleaseNote

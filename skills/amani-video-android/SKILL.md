---
name: amani-video-android
description: "Integrate the Amani Video Call SDK on Android using the live Amani documentation. Use when adding or implementing the Amani Video Call SDK on Android."
metadata:
  amani:
    platform: "mobile"
    sdk: "video"
...
- **Preparation** — https://documentation.amani.ai/documents/androidVideo/Preparation
- **Initializing and using the SDK** — https://documentation.amani.ai/documents/androidVideo/initalizing-and-using-the-sdk
- **SDK Release Notes** — https://documentation.amani.ai/documents/androidVideo/ReleaseNote
